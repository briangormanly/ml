...
% You are always you
\providecommand\Maristfromname{Pablo Picasso}
\providecommand\Maristfromtitle{Prof of CS}
\providecommand\Maristfromdegree{Ph.D.}
\providecommand\Maristfromdept{Dept of CS}
\providecommand\Maristschooltel{(845) 575-3000 ext. 1234}
\providecommand\Maristfromemail{\url{Pablo.Picasso@Marist.edu}}
\providecommand\Maristfromweb{\url{https://www.picasso.com}}
...
\fancyhead[L]{
    ...
    \begin{textblock*}{6.375in}[0.15,0.1](4.45in,0.55in)
        \includegraphics[width=1.4in]{\Maristlogofile}
    \end{textblock*}
}
...
\AtEndDocument{
    ...
    \begin{addmargin}[7.25cm]{0em}
      ...
      \Maristofficetel\ifthenelse{\equal{\Maristofficetel}{}}{}{\\} 
      \Maristfromemail\ifthenelse{\equal{\Maristfromemail}{}}{}{\\} 
      \Maristfromweb\ifthenelse{\equal{\Maristfromweb}{}}{}{\\} 
      \ifthenelse{\equal{\Maristenclosure}{}}{}{\bigskip\bigskip\emph{\Maristenclosure}\\}
    \end{addmargin}
}
